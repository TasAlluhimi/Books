...
function Faivorate() {
    ...
    React.useEffect(()=>{
      ...
      .then(res=>{
        console.log(res.data.faiv_list);
        setData(res.data.faiv_list);
      })
    }, [])
...
<div className='text-center text-3xl mt-16 font-bold'>♡ Faivourate Books List ♡</div>
      ...
      {data.length === 0 ? (
        <p className='text-2xl'>There is No Faivourate books :c</p>
      ) : (
